package microservices.uaa.repository;

import microservices.uaa.UaaApp;
import microservices.uaa.config.Constants;
import microservices.uaa.config.audit.AuditEventConverter;
import microservices.uaa.domain.PersistentAuditEvent;
...
import static microservices.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
